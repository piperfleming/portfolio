    ...
    press: [
      {
        ...
        description: "An immunologist's lucky accident — bacteriophages surviving UV exposure — sparked a collaboration with a marine ecologist to engineer a biodegradable sunscreen. My sand dollar embryo trials at Hopkins showed the phage-based formula caused no abnormalities, unlike commercial sunscreen.",
      },
      {
        ...
        description: "I presented my team's findings at Stanford's annual Symposium of Undergraduate Research and Public Service — phage-based sunscreen left sand dollar embryos unharmed while chemical sunscreen caused significant developmental abnormalities.",
      },
    ],
  },
  {
